...
/**
 * Creates an otherPersonUsers of a contract object
 *
 * body  a cel person or mco user object (optional)
 * contractIdref contractIdref Alphanumeric ID of the contract to get
 * no response value expected for this operation
 **/
exports.setOtherPersonUsers = function(body,contractIdref) {
  return new Promise(function(resolve, reject) {
    resolve();
  });
}
...
/**
 * Create a party of a contract object
 *
 * body  a party object (optional)
 * contractIdref contractIdref Alphanumeric ID of the contract to get
 * no response value expected for this operation
 **/
exports.setParties = function(body,contractIdref) {
  return new Promise(function(resolve, reject) {
    resolve();
  });
}
